...
use DTS\eBaySDK\MerchantData\Enums\PromotionalSaleStatusCodeType;
...
class PromotionalSaleStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\PromotionalSaleStatusCodeType', $this->obj);
    }
}
